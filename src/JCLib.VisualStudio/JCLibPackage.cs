...
[InstalledProductRegistration("JC Lib - Visual Studio", "JC Lib browser with structured parameters, documented options, multi-select pickers, file browsers, external packs and WPF Visual Pack Editor", "1.3.7")]
